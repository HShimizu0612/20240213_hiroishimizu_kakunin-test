    ...
    <form class="contact-form" action="/confirm" method="post">
        ...
        <table class="contact-form__table">
            <tr>
                ...
                <td>
                    <div class="contact-form__name">
                        <input class="contact-form__name-input" type="text" name="name" placeholder="例: 山田">
                        <input class="contact-form__name-input" type="text" name="name" placeholder="例: 太郎">
                    </div>
            ...
            <tr>
                ...
                <td>
                    <input class="contact-form__email-input" type="email" name="email" placeholder="例: test@example.com">
                    <div class="form__error">
                        @error('email')
                        {{ $message }}
                        @enderror
            ...
            <tr>
                ...
                <td>
                    <div class="contact-form__tel">
                        <input class="contact-form__tel-input" type="tel" name="tel" placeholder="08012345678">
                        <!-- 入力欄を3分割したい
                        <p>-</p>
                        <input class="contact-form__tel-input" type="tel" name="tel[]" placeholder="1234">
                        <p>-</p>
                        <input class="contact-form__tel-input" type="tel" name="tel[]" placeholder="5678">
                        -->
                    </div>
                    <div class="form__error">
                        @error('tel')
            ...
            <tr>
                ...
                <td>
                    <div class="contact-form__category">
                        <select class="contact-form__category-select" name="categoryid">
